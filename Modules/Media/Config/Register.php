...
$config['namespaces']['Media\Models'] = MODULES_DIR."/Media/Models";
$config['namespaces']['Media\Controllers'] = MODULES_DIR."/Media/Controllers";
...
$app->map('/api/Media/Search',function() use ($app){
	...
	$media = new Media\Controllers\Search();
...
$app->get('/api/Media/Zip/{id}',function($id) use ($app){
	...
	$media = new Media\Controllers\Media();
...
$app->map('/api/Media/Repo/add',function() use ($app){
	...
	$media = new Media\Controllers\Repo();
	$args = array(
